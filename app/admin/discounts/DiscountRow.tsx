...
export function DiscountRow({ product }: { product: Product }) {
  ...
  return (
    <div className="flex items-center gap-4 rounded-md border border-neutral-200 bg-white p-3">
      ...
      <input
        ...
        placeholder="%"
        className="w-20 border border-neutral-300 px-2 py-1.5 text-center text-sm"
      />
      <button
        onClick={save}
        disabled={saving}
        className="bg-brand-black px-4 py-1.5 text-xs uppercase tracking-wide text-white hover:opacity-90 disabled:opacity-50"
      >
